...
Weather is a universal conversation topic in Japan, where seasons play an important cultural role. This lesson covers weather conditions, temperature words, and related actions.
...
- さいていきおん (最低気温) — low temperature
- こうすいかくりつ (降水確率) — chance of precipitation
:::
...
- きょうは **暑い** です。— Today is hot. (weather)
- このスープは **熱い** です。— This soup is hot. (temperature of object)
:::

:::tip つめたい vs さむい
- **寒い (さむい)** = cold weather/air temperature
- **冷たい (つめたい)** = cold to touch (drinks, ice, water)

Example:
- きょうは さむい です。— Today is cold.
- つめたい みずを ください。— Please give me cold water.
:::
...
| Hiragana | Kanji | Romaji | English | Type |
|----------|-------|--------|---------|------|
| きせつ | 季節 | kisetsu | 📅 season | noun |
| はる | 春 | haru | 🌸 spring | noun |
| なつ | 夏 | natsu | 🌻 summer | noun |
| あき | 秋 | aki | 🍂 autumn, fall | noun |
| ふゆ | 冬 | fuyu | ⛄ winter | noun |

- **Rainy Season**: 梅雨 (tsuyu/baiu) is the rainy season in June-July
- **Cherry Blossoms**: 花見 (hanami) — viewing cherry blossoms in spring is a beloved tradition
