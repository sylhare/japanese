...
## Polite Forms and Honorifics

### When Talking About Others' Families

| Hiragana | Kanji | Romaji | English | Type |
|----------|-------|--------|---------|------|
| ごかぞく | ご家族 | gokazoku | family (polite) | noun |
| おとうさま | お父様 | otousama | father (very polite) | noun |
| おかあさま | お母様 | okaasama | mother (very polite) | noun |
| おじいさま | お爺様 | ojiisama | grandfather (very polite) | noun |
| おばあさま | お婆様 | obaasama | grandmother (very polite) | noun |

**Examples:**
- ごかぞくは おげんきですか？ (gokazoku wa ogenki desu ka?) - How is your family?
- おとうさまは おしごとですか？ (otousama wa oshigoto desu ka?) - Does your father work?
...
1. **How do you say "My family has five people" in Japanese?**
2. **What's the difference between ちち and おとうさん?**
3. **How do you politely ask about someone's family?**
