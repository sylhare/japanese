...
sidebar_position: 19
title: Conditional - と
description: Learn how to express natural conditionals and automatic consequences using と
tags: [grammar, conditional, と, particles]
---
...
<NextSteps items={[
  {
    title: 'Conjunctions',
    description: 'Learn how to list items using と and や',
    to: './conjunctions',
  },
  {
