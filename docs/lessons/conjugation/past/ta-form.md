...
### After Doing Something (〜たあとで)

> ごはんを**たべた**あとで、さんぽする。
> *After eating, I'll take a walk.*
...
- **〜たら** — if/when: いったら (if/when I go) → see [Conditional - と / たら](/docs/lessons/grammar/conditional)
...
<NextSteps items={[
  ...
  },
  {
    ...
    description: "Learn to use たら (ta-form + ら) for conditionals",
    to: "/docs/lessons/grammar/conditional"
  }
]} />
